...
const Testimonial = () => {
  return (
    <>
      <div id="testimonials" class="container mx-auto max-w-6xl p-2 md:p-10">
        <div class="grid gap-6 grid-cols-1 text-white md:grid-cols-4 md:grid-rows-1">
          <div class="relative p-10 rounded-xl bg-purple-700 col-span-1 md:col-span-4 md:row-span-1 h-90">
            <img
          ...
          <div class="p-10 rounded-xl bg-gray-600  md:row-span-1 md:col-span-4">
          ...
          <div class="hidden p-10 rounded-xl text-gray-900 bg-white border-4 md:block col-span-1 row-span-1 md:row-span-1 md:col-span-4">
            <div class="flex space-x-4">
              <img
          ...
          <div class="p-10 rounded-xl text-gray-900 bg-white border-4 col-span-1 md:col-span-4 row-span-1">
            <div class="flex space-x-4">
              <img
            ...
            <div class="p-10 rounded-xl bg-gray-900 col-span-1 md:col-span-4">
              <div class="flex space-x-4">
                <img
            ...
            <div class="p-10 rounded-xl text-gray-900 bg-white md:hidden border-4 md:col-span-1 md:row-span-1">
              <div class="flex space-x-4">
                <img
                  src="images/image-kira.jpg"
                  alt=""
