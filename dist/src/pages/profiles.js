...
const Navbar_jsx_1 = __importDefault(require(".././components/Navbar.jsx"));
...
const FriendProfiles = () => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Navbar_jsx_1.default, null),
        react_1.default.createElement("div", { className: "flex items-center justify-center min-h-screen bg-darkViolet" },
            react_1.default.createElement("div", { className: "grid grid-row-1  bg-white p-3 m-3 space-y-1 shadow-2xl rounded-3xl md:p-20" },
                react_1.default.createElement("div", { className: 'text-black-800 font-bold sans-serif text-3xl' }, "My Friends"),
                react_1.default.createElement("div", { className: "flex items-center justify-center space-y-3\r\n                      md:flex-row md:space-y-0 md:space-x-6 md:mb-24 md:justify-end" },
...
exports.default = FriendProfiles;
